let peliculas = [
  ...
  //funcion que retorna la cantidad de peliculas en el idioma 
  //ingles "en"
  //HINT: (filter)
  function peliculasEnIngles() {
  ...
  console.log(`Peliculas en ingles ${peliculasEnIngles()}`);


  //funcion q imprime los generos q tiene una pelicula
  //@param {*} title
  ...
  console.log(printGenresByTitleMovie("Mulan"));
